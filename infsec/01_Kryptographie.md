...
## Sie kennen einige Aspekte der Geschichte der symmetrischen Kryptographie

## Sie kennen zwei Typen von Block-Chiffren, Feistel- und Substitutions-Permutationsnetzwerke (SPN) und können die Funktionsweise von DES und AES im Detail erklären.
## Sie kennen fünf wichtigte Betriebsmodi von Block-Chiffren
## Sie können die Funktionsweise von Stromchiffren erklären
# Test Title
This is a test
